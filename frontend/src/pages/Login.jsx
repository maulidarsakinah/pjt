  ...
  return (
    <div className="login-page">
      <div className="left-panel">
        ...
        >
          <path
            d="M 0 120 Q 250 20 500 120 T 1000 80 L 1000 300 L 0 300 Z"
            fill="rgba(255,255,255,0.03)"
          />
          <path
            d="M 0 180 Q 250 80 500 180 T 1000 140 L 1000 300 L 0 300 Z"
            fill="rgba(255,255,255,0.07)"
          />
          <path
            d="M 0 250 Q 250 180 500 250 T 1000 210 L 1000 300 L 0 300 Z"
        ...
        <div className="hero-text">
          ...
          <p>
            Akses pemantauan data debit air dan hidrologi real-time
            terintegrasi.
          </p>
        </div>
        ...
        <div className="illustration-shell">
          ...
          >
            ...
            <g className="panel panel-center" transform="translate(210, 130)">
              <path
                d="M 160 220 L 180 300 L 220 300 L 200 220 Z"
                fill="#94a3b8"
              />
              <rect
                x="140"
              ...
              <g className="chart-graphic">
                <path
                  ...
                  d="M 40 190 L 40 170 Q 90 140 160 160 T 260 120 T 340 140 L 340 190 Z"
                  fill="rgba(58, 75, 207, 0.15)"
                />
                <path
                  className="chart-line"
                  d="M 40 170 Q 90 140 160 160 T 260 120 T 340 140"
                  fill="none"
                  stroke="#3A4BCF"
                  strokeWidth="4"
                  strokeLinecap="round"
                />
                <circle
                  className="chart-point chart-point-one"
                  cx="160"
                  cy="160"
                  r="5"
                  fill="#ffffff"
                ...
                />
                <circle
                  className="chart-point chart-point-two"
                  cx="260"
                  cy="120"
                  r="5"
                  fill="#ffffff"
